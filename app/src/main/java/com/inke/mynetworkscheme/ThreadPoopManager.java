...
public class ThreadPoopManager {
    private static ThreadPoopManager threadPoopManager = new ThreadPoopManager();

    public static ThreadPoopManager getInstance() {
        return threadPoopManager;
    }
